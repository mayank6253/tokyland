      ...
      <section>
        <div id="faq">
          <div className="container">
            <div className="token-faq" style={{ marginTop: "100px" }}>
              <div className="token-faq-content text-center">
                <span className="gradient-text">Token FAQ</span>
                <h2 className="text-light my-3">Frequently Questions</h2>
                <p
                  style={{
                    color: "#81819C",
                  }}
            ...
            <div className="row">
              <div className="col-12 col-lg-5 col-md-12">
                <div className="faq-image">
                  <img src={faq1} alt="" className="faq-img" />
                </div>
              </div>
              <div className="col-12 col-lg-5 col-md-12">
