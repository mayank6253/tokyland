      ...
      <section>
        <div className="container">
          <div className="buy text-center">
            <span className="gradient-text my-5 fs-3">
              How to buy Bridge to Cronos{" "}
            </span>
          </div>
          <div className="row">
              ...
              <div className="eft-heading">
                <div className="eft-desc">
                  <ul className="eftList-item text-light">
                    ...
                    <li>
                      Insert the amount of BNB you would like to swap for
                      ERabbit
                    </li>
                    <li>
                      Change the slippage amount to between 1%-15%. Depending on
                      the buy and sell pressure, higher slippage may be
                      necessary
                    </li>
                    <li>
                  ...
                  <p className="eft-para text-light">
                    If you prefer the PancakeSwap option, click “select a
                    currency” and enter and import the $EFT contract address:
                    <a
